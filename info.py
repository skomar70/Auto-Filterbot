...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003036018855').split()]
...
REQ_CHANNEL_ENV = environ.get("REQ_CHANNEL", '-1002963779063')
